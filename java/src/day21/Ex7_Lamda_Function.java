...
//프로그램 검색기능에 적용할 수 있음.
public class Ex7_Lamda_Function {
	...
	public static void main(String[] args) {
		...
		BiFunction<Student, String, Integer> function = (Student std, String subject) -> {
		...
		System.out.println("학생들의 국어 총점 : " + sum(list, "국어", function));//240
		System.out.println("학생들의 영어 총점 : " + sum(list, "영어", function));//250
		System.out.println("학생들의 수학 총점 : " + sum(list, "수학", function));//320
