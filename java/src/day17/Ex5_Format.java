...
public class Ex5_Format {
	...
	public static void main(String[] args) {
		...
		//문자열 포맷을 생성. 원하는 변수값이 들어가야 할 위치를 {숫자}로 표시
		String msFotmat = "아이디: {0}, 이름: {1}, 번호: {2}";
		//MessageFormat.format(문자열포맷,객체들)을 이용하여 문자열 포맷에 값들을 대입한 후 문자열 생성
		String user2 = MessageFormat.format(msFotmat, id, name, number);
		System.out.println(user2);
		Object objs [] = {"abc", "홍길동", "010-1234-5678"};
		String user3 = MessageFormat.format(msFotmat, objs);
