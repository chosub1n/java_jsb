...
public class HomeController {
	...
	/* 접근제한자 : public - 고정
	 * 리턴타입 : ajax(나중에 배움)를 이용한 경우는 제외하고는 기본적으로 ModelAndView
	 ...
	 * 이때, hobby와 time의 타입이 null을 처리할 수 없는 타입이면 에러가 발생
	 * */
	...
	public ModelAndView userUpdateGet(ModelAndView mv, MemberVO member){
