	...
	let bd_num = '${board.bd_num}'  
  			...
  			$.ajax({
		        ...
		        success : function(data){
		        	...
		        	if(data == '1'){		        		
		        		...
		        		alert('해당 게시글을 추천을 취소했습니다.')
		        	}else if(data == '-10'){
		        		alert('해당 게시글을 비추천을 취소했습니다.')
		        	}else
		        		alert('잘못된 접근입니다.')
		        }	        
			});
  	...
  	$(function(){
  		...
  		$(document).on('click', '.btn-comment-update', function(){
  			...
  			str = '<button class="btn-comment-update-complete ml-2">수정 완료</button>'
  			str += '<button class="btn-comment-update-cancel ml-2">수정 취소</button>';
  		...
  		$(document).on('click', '.btn-comment-reply', function(){
  			...
  			str += '<button class="btn-cancel-reply ml-2">답글 취소</button>'
  			$(this).after(str);
  			$(this).hide();//답변버튼 감춤
        ...
        success : function(data){       	
        	...
        	str +=
          	'<div class="item-comment">' +
          	  ...
          	  '<button class="btn-comment-update ml-2">수정</button>';          		  
          	  }
          	str +=
          	  '<button class="btn-comment-reply ml-2">답글</button>' +    	
          	'</div>'
        	}
