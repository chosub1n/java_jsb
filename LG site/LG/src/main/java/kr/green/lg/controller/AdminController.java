...
public class AdminController {
	...
	public ModelAndView productInsertPost(ModelAndView mv, ProductVO product, MultipartFile file,
		...
		messageService.message(response, "제품을 등록했습니다.", "/springlg/admin/product/list");
	...
	public ModelAndView productDeletePost(ModelAndView mv, HttpServletResponse response, String pr_code) {
		...
		if(res)
			messageService.message(response, "제품을 삭제했습니다.", "/springlg/admin/product/list");
		else
			messageService.message(response, "제품을 삭제하지 못했습니다.", "/springlg/admin/product/list");
		mv.setViewName("redirect:/admin/product/list");		
		return mv;
	}
	...
	public ModelAndView productUpdatePost(ModelAndView mv, ProductVO product, MultipartFile file,
		...
		if(res)
			messageService.message(response, "제품을 수정했습니다.", "/springlg/admin/product/list");
		else
			messageService.message(response, "제품을 수정하지 못했습니다.", "/springlg/admin/product/list");
		mv.setViewName("/admin/productUpdate");
		return mv;
	}
	...
	public ModelAndView noticeInsertPost(ModelAndView mv, BoardVO board, 
		...
		if(res)
			messageService.message(response, "공지사항이 등록됐습니다.", "/springlg/admin/notice/list");
		else
			messageService.message(response, "공지사항이 등록에 실패했습니다.", "/springlg/admin/notice/insert");
		return mv;
	}
	...
	public ModelAndView noticeUpdatePost(ModelAndView mv, BoardVO board,
		...
		if(res)
			messageService.message(response, "공지사항이 수정됐습니다.", "/springlg/admin/notice/list");
		else
			messageService.message(response, "공지사항 수정에 실패했습니다.", "/springlg/admin/notice/list");
		return mv;
	}
}
