...
-- 브로커 영화에 대한 정보를 추가하는 쿼리
-- http://www.cgv.co.kr/movies/detail-view/?midx=85829  
-- 영화 정보 추가      
INSERT INTO `cgv`.`movie` (`mo_title`, `mo_ genre`, `mo_age`, `mo_time`, `mo_open_date`, `mo_detail`, `mo_thumb`) 
VALUES ('브로커', '드라마', '12세이상', '129', '2022-06-08', 
	'베이비 박스, 그곳에서 의도치 않게 만난 이들의 예기치 못한 특별한 여정이 시작된다.', NULL);
